  ...
  try {
    ...
    const testFounders = await db.insert(founders).values([
      ...
      },
      {
        ...
        companyName: "NFT Marketplace Pro",
        description: "Next-gen NFT marketplace with advanced discovery, social features, and creator monetization tools. Building the future of digital art and collectibles.",
        pitchDeckUrl: "https://drive.google.com/file/d/0987654321/view",
        amountRaising: 1500000,
        traction: "• 50k+ registered users\n• 15k NFTs traded monthly\n• $1M+ in transaction volume\n• 200+ verified artists",
        ecosystem: "polygon",
        vertical: "nfts",
        websiteUrl: "https://nftmarketplacepro.io",
        githubUrl: "https://github.com/nftmarketplacepro",
        isVisible: true,
        isFeatured: true,
        upvotes: 34,
        votes: 41,
      },
      {
        ...
        companyName: "Web3 Gaming Hub",
        description: "Play-to-earn gaming platform with integrated NFT marketplace and DeFi yield farming. Creating sustainable gaming economies for the next billion users.",
        pitchDeckUrl: "https://drive.google.com/file/d/1122334455/view",
        amountRaising: 3000000,
        traction: "• 25k+ daily active users\n• 100k+ game sessions monthly\n• $500k in player earnings\n• 5 launched games",
        ecosystem: "solana",
        vertical: "gaming",
        websiteUrl: "https://web3gaminghub.com",
        githubUrl: "https://github.com/web3gaminghub",
        isVisible: true,
        isFeatured: true,
        upvotes: 62,
        votes: 71,
