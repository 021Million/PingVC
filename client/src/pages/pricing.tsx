      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <Card className="border-primary/50 shadow-lg scale-105">
              ...
              <CardContent>
                ...
                <Button className="w-full mt-6" asChild>
                  <Link href="/ping">Browse VCs <ArrowRight className="ml-2 h-4 w-4" /></Link>
                </Button>
              </CardContent>
            </Card>
            ...
            <Card className="border-gray-200">
              ...
              <CardContent>
                <ul className="space-y-3">
                  <li className="flex items-center">
                    <Check className="h-4 w-4 text-green-500 mr-2" />
                    <span className="text-sm">Featured on marketplace</span>
                  </li>
                  <li className="flex items-center">
                    <Check className="h-4 w-4 text-green-500 mr-2" />
                    <span className="text-sm">Email newsletter to VC & Angels</span>
                  </li>
                  <li className="flex items-center">
                    <Check className="h-4 w-4 text-green-500 mr-2" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card className="text-center border-primary/50">
              <CardContent className="pt-6">
                ...
                <div className="text-2xl font-bold text-primary mb-4">$250 - $2500+</div>
        ...
        <div className="mb-16">
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">How do VCs & Angels get paid?</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600">They receive 85% of their intro fee weekly via verified payment methods. We retain 15% as a platform fee to cover operations and verification costs.</p>
              </CardContent>
            </Card>
