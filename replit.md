...
- July 16, 2025. Updated marketplace data source to pull projects from "Project Submissions" Airtable table instead of "Scout" table. Marketplace now displays all projects with Publishing Status = 'Published' from project submissions, providing unified data flow from project setup form directly to marketplace visibility. Added filtering to only show published projects with valid company names.